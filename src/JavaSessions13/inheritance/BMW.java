...
public class BMW extends Car{
	...
	//an autostart(doesn't want to have the regular outdated start of the Car class)
	//This is not the inherited method but the override method
	//start() is defined in the parent class the exact same is defined in the child class aswell
	
	//Method OVerriding vs Method Overloading
	//Overriding happens between parent n child but Overloading happens within the same class
	...
	//the same name
	//the same number of parameters(0 parameters in the parent class in the start() and the same in the child class)
	//i.e. same signature->return type n the parameters in the method n access modifier should be same
	...
	//What type of Polymorphism?It is Compile Time Polymorphism(Static Polymorphism)
	
	@Override//Its not mandatory to use but a good practice
	//if this annotation doesn't give any error then the method is successfully override
	public void start() {
