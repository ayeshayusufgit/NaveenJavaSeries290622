...
public class TestCar {
	...
	public static void main(String[] args) {
		...
		//      		  the BMW class even though they are siblings
		BMW.drive();//Accessing the static method of BMW class
		b.drive();//static method can be accessed like this but its a bad practice, gives a warning
		//static methods can be inherited from the parent to the child but not overidden
		...
		c.stop();
		c.refuel();
		//Car.drive();//Accessing the static method of Car class
		//c.drive();//static method can be accessed like this but its a bad practice, gives a warning
